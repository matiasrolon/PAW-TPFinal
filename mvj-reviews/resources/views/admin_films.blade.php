        ...
        <div class="resultado-seleccionado resultado-seleccionado-oculto">
          ...
          <div class="info">
                  <div class="campo">
                      ...
                      <textarea required class="editable titulo" name="name" rows=1 cols=80 disabled></textarea>
                  </div>
                  ...
                  <div class="campo">
                      ...
                      <textarea required class="editable categoria" name="name" rows=1 disabled></textarea>
                  </div>

                  <div class="campo">
                      <label for="" >Fecha de estreno:</label>
                      <textarea required class="editable fecha-estreno" name="name" rows=1 disabled></textarea>
                  </div>
