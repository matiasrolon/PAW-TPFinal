...
@section('publics')
    ...
    <link href="{{ asset('css/login.css', false) }}" rel="stylesheet">
@endsection

@section('content')
    <div class="welcome-card">
        <h2 class="tittle">BIENVENIDO A MVJ REVIEWS</h2>
        <p class="description">Sitio especializado en criticas de contenido audiovisual.</p>
        <p>Aquí podrá ver lo mas destacado en la actualidad sobre:</p>
        <ul>
        ...
        <div class="register-link-desktop">
            ...
            <a class="btn btn-link" href="{{ route('register') }}">
                <button class="btn-mvj register" type="button" name="button">Crear Cuenta</button>
            </a>
        </div>
    </div>
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div>
                    <div class="login-btn-cnt" >
                        <button type="submit" class="btn-mvj login">{{ __('Login') }}</button>
